# Generated by Django 5.2.1 on 2025-05-19 19:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('appointment_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='appointment_service.appointmenttype')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('appointment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reminders', to='appointment_service.appointment')),
            ],
            options={
                'db_table': 'reminders',
        ...
        migrations.CreateModel(
            ...
            options={
                'db_table': 'time_slots',
                'ordering': ['start_time'],
                'indexes': [models.Index(fields=['provider_id'], name='time_slots_provide_8f1403_idx'), models.Index(fields=['start_time'], name='time_slots_start_t_a5ce22_idx'), models.Index(fields=['is_available'], name='time_slots_is_avai_5556fe_idx')],
            },
        ),
        migrations.AddField(
